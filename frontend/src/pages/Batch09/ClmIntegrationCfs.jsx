...
export default function ClmIntegrationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/custom/clm-integration', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>CLM integration</h1>
